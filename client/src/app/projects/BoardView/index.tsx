  ...
  return (
    ...
    >
      {task.attachments && task.attachments.length > 0 && (
        <Image
          src={`https://jpm-s3-image.s3.us-west-1.amazonaws.com/${task.attachments[0].fileURL}`}
          ...
          <div className="flex -space-x-[6px] overflow-hidden">
            {task.assignee && (
              <Image
                ...
                src={`https://jpm-s3-image.s3.us-west-1.amazonaws.com/${task.assignee.profilePictureUrl!}`}
            ...
            {task.author && (
              <Image
                ...
                src={`https://jpm-s3-image.s3.us-west-1.amazonaws.com/${task.author.profilePictureUrl!}`}
